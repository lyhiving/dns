...
AlibabaCloud::accessKeyClient('ALIYUN_AK', 'ALIYUN_SK')
...
try {
    $result = AlibabaCloud::rpc()
        ...
        ->request();
    $data = $result->toArray();
    $dns =  $data['DomainRecords']['Record'];
    // file_put_contents(__DIR__.'/aliyun_domain.com.json',json_encode($dns,JSON_UNESCAPED_UNICODE));
    dump($dns);
    exit;
